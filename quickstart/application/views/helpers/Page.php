...
class Zend_View_Helper_Page extends Zend_View_Helper_Abstract {
    ...
    public function page($total_rows, $rows_per_page, $page_num, $extra_params = array()) {
        ...
        $html = '<div class="sp-pagination"><ul class="">';

        if($current === 1) {
            $html .= "<li class='arrow unavailable'><a>«</a></li>";            
        } else {
            $html .= "<li class='arrow'><a href=".$this->get_page_link($previous).">«</a></li>";
        }
        ...
        if(!in_array(1, $pages)) {
            ...
            if (2 < $first_page) {
                $html .= "<li class='unavailable'><a>&hellip;</a></li>";                
            }
        }
        ...
        if($current == $last_page) {
            $html .= "<li class='arrow'><a>»</a></li>";            
        } else {
            $html .= "<li class='arrow'><a href=".$this->get_page_link($next).">»</a></li>";
        }

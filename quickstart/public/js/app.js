jQuery(document).ready(function ($) {
    ...
    if ( $(document).foundation ) {
        ...
        // orbit
        if ( $('ul[data-orbit]')[0] ) {
            if ( $('ul[data-orbit]').find('li').length === 1 ) {
                $('ul[data-orbit]').siblings().hide();
            }
        }
    }
     ...
     */
    $('#main-nav .fold-button').click(function(e) {
        ...
        if ( parent.hasClass('unfolded') ) {
            ...
            $('#main-nav .top-bar').slideUp();
        } else {
            parent.addClass('unfolded');
            $('#main-nav .top-bar').slideDown();
        }
    });
    ...
    $('body').click(function(e) {
        ...
        if ( !$(e.target).parents('#main-nav')[0] &&
            $mainNav.find('.unfolded')[0] ) {

            $mainNav.find('.unfolded').removeClass('unfolded');
            $mainNav.find('.top-bar').slideUp();
        }
    });
     ...
     * toggle search
     */
    $('[data-search]').find('.search-submit').click(function() {
    ...
    /**
     * click table tr, open item detail page
     */
    $('tr[data-href]').on('click', 'td', function() {
